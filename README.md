...
package.json — (Optional) Included for dependency management.
...
JavaScript
{
    ...
    imdbRating: "7.5",
    Runtime: "120 min",
    Poster: "[https://link-to-image.jpg](https://link-to-image.jpg)"
}
...
🤝 Contributing
Pull requests are welcome! Whether it's improving documentation, enhancing accessibility, or refactoring the app to fetch data from a live remote API, feel free to contribute.
